...
public class Token extends Model {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -947787424200295373L;
	...
	// -- Queries
	public static Model.Finder<String, Token> find = new Finder<String, Token>(
	...
	private static void sendMail(User user, TypeToken type, String email)
		...
		String urlString = "http://" + externalServer + "/" + type.urlPath
				+ "/" + token.token;
